categories = ['Tools', 'Create', 'Options', 'Shading', 'Relations', 'Animation', 'Physics', 'Input', 'Output', 'Shader', 'Color', 'Pattern', 'Textures', 'Texture', 'Color', 'Vector', 'Matte', 'Distort', 'Converter', 'Script', 'Group', 'Layout', 'Grease Pencil']
...
spaces = {'PROPERTIES': {'WINDOW': [
    ...
    'NODE_CYCLES_LIGHT_PT_settings',
    'NODE_EEVEE_MATERIAL_PT_settings_surface',
    'NODE_EEVEE_MATERIAL_PT_settings_volume',
